...
description: "Komponowalne komponenty ułatwiają budowanie elastycznych i wielokrotnego użytku interfejsów w React."
tags: ["Frontend", "Architektura", "React"]
---
...
## Problem: Podejście Konfiguracyjne 
...
## Rozwiązanie: Composable Components

Rozwiązaniem jest zastosowanie **Inversion of Control**. Zamiast kazać komponentowi zgadywać, co i jak ma wyświetlić na podstawie flag, przekazujemy mu gotowe fragmenty UI jako `children`.
...
> Stosuj Composable Components tam, gdzie elastyczność i utrzymanie są ważniejsze niż minimalna ilość kodu lub mikro-optimalizacja wydajności.
