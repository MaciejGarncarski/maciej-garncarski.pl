---
title: "NPM i OIDC - Case Sensitivity"
...
TL;DR: `MaciejGarncarski` zamiast `maciejgarncarski` w konfiguracji OIDC dla NPM.

Niedawno podczas konfiguracji OIDC do publikacji paczki, zauważyłem, że NPM nie rozpoznaje poprawnie konfiguracji.

<figure>
  <Picture data-blog-img src={before} alt="Błędna konfiguracja OIDC" />
  <figcaption data-figcaption>Konfiguracja wygląda na poprawną.</figcaption>
</figure>
